...
import { SlidersHorizontal, Grid3X3, List, ChevronDown, X, Search, PackageSearch } from 'lucide-react';
      ...
      <div className="luxury-container py-12">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-32">
            <PackageSearch className="mx-auto mb-6 h-16 w-16 text-orange-500" strokeWidth={1.5} />
